                                        ...
                                        properties: {
                                                                            ...
                                                                            properties: {
                                                                                socialMediaModels: {
                                                                                    ...
                                                                                    'x-validator': [
                                                                                        {
                                                                                            validator:
                                                                                                '{{subKeyPhoneNumberValidator("WHATSAPP")}}',
                                                                                            triggerType: 'onBlur'
                                                                                        }
                                                                                    ],
                                                                                    'x-index': 1
                                            ...
                                            edit: {
                                                ...
                                                'x-component-props': {
                                                    children: {
                                                        ...
                                                        props: {
                                                            size: 'small',
                                                            type: 'text',
                                                            id: 'id-btn-customer-detail-contact-edit',
                                                            style: {
                                                                color: '#FF934A'
                                                            },
                                                            children: [
                                                ...
                                                'x-reactions': {
                                                    ...
                                                    fulfill: {
                                                        schema: {
                                                            'x-hidden': "{{$self.pattern === 'editable'}}"
                                                        }
                                                    }
                                                },
                                                'x-index': 2
                                            ...
                                            vy7thjdraos: {
                                                ...
                                                'x-reactions': {
                                                    ...
                                                    fulfill: {
                                                        schema: {
                                                            'x-hidden':
                                                                "{{$self.pattern === 'editable' || ($values.contactModels || []).length === 1}}"
                                                        }
                                                    }
                                                },
                                                'x-index': 3
