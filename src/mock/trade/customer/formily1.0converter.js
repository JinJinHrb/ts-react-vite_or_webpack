export default {
    ...
    jg1ging5grt: {
        ...
        isCanvas: false,
        props: { field: { type: 'void', module: true, 'x-component': 'ModuleCard', title: '基本信息' } },
        displayName: 'Module',
        custom: {},
        parent: 'ROOT',
        hidden: false,
        nodes: [],
        linkedNodes: { module_left: 'HWsrHAflDh', module_right: 'YZ73n2A8uV' }
    },
    HWsrHAflDh: {
        type: 'div',
        isCanvas: true,
        props: {
            ...
            field: { type: 'void', 'x-component': 'ModuleLeft' }
        },
        displayName: 'div',
        custom: {},
        parent: 'jg1ging5grt',
    ...
    YZ73n2A8uV: {
        ...
        props: {
            name: 'ModuleRight',
            className: 'moduleItem_3AhEv',
            field: { type: 'void', 'x-component': 'ModuleRight' }
        },
        displayName: 'div',
        custom: {},
        parent: 'jg1ging5grt',
    ...
    '7pktwpbt1oe': {
            ...
            field: {
                ...
                properties: {
                    contactModels: {
                        ...
                        'x-component-props': { id: 'contactModels', twoColumn: true },
                        'x-validator': [],
                        'x-index': 0,
                        default: [{}],
                        maxLength: 15,
                        items: {
                            ...
                            properties: {
                                tgfnpbqvlgu: {
                                    ...
                                    properties: {
                                        tgfnpbqvlgl: { type: 'void', 'x-component': 'ArrayItems.Remove', 'x-index': 1 },
                                        tgfnpbqvlgm: {
                                            type: 'void',
        ...
        hidden: false,
        nodes: [],
        linkedNodes: { module_left: 'RQPo4CrX7e', module_right: '32wVskLBQ4' }
    },
    RQPo4CrX7e: {
        type: 'div',
        isCanvas: true,
    ...
    '0chqj6titjf': {
        type: { resolvedName: 'Module' },
        isCanvas: false,
        props: { field: { type: 'void', module: true, 'x-component': 'ModuleCard', title: '特征信息' } },
        displayName: 'Module',
        custom: {},
        parent: 'ROOT',
        hidden: false,
        nodes: [],
        linkedNodes: { module_left: '9j86GWnU_Q', module_right: 'fSfzyoIGUs' }
    },
    '9j86GWnU_Q': {
        type: 'div',
        isCanvas: true,
    ...
    hudxz1dtorr: {
        type: { resolvedName: 'Module' },
        isCanvas: false,
        props: { field: { type: 'void', module: true, 'x-component': 'ModuleCard', title: '附件' } },
        displayName: 'Module',
        custom: {},
        parent: 'ROOT',
        hidden: false,
        nodes: [],
        linkedNodes: { module_left: 'eAjONKvzlV', module_right: 'vmcoGOi3Nh' }
    },
    eAjONKvzlV: {
        type: 'div',
        isCanvas: true,
    ...
    TkMjwpTWjz: {
        ...
        props: {
            field: {
                ...
                'x-filter': true,
                'x-decorator-props': { colon: false },
                'x-component-props': { optionFilterProp: 'label', showSearch: true, id: 'status', allowClear: true },
                'x-validator': [],
                type: 'string',
                title: '客户状态',
                enum: [
